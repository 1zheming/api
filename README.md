...
### 活动反馈
现行的应用型人工智能API能够服务于大量产业，在不同的领域发光发热。随着应用型人工智能技术的逐渐成熟，能够实现落地的项目将会越来越多，人工智能将会更好的造福我们的生活。


### 学习反馈
本学期对于API、人工智能与机器学习的了解、认识与实践，我发现我原来认为技术难度较高的很多后端问题其实可以通过更见简单快捷的方式进行解决。人工智能的加成能够让我们的项目更加脱颖而出，符合时代发展的需要。
